...
<template>
  <div class="kb">
    <template v-if="!selectedArticle">
      ...
      <KSkeleton v-if="loading && !articles.length" type="card" :count="3" />
      ...
      <template v-else>
        ...
        <div v-if="isSearching" class="kb__search-info">
          ...
          <KButton variant="ghost" size="sm" @click="searchQuery = ''">Clear search</KButton>
        </div>
    ...
    <template v-else>
      <div class="kb__detail">
        <KButton variant="ghost" size="sm" @click="closeArticle" class="kb__back-btn">
          ← Back
        </KButton>
