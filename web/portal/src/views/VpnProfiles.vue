...
<template>
  <div class="vpn-profiles">
    ...
    <Skeleton v-if="loading && !profiles.length" type="card" :count="3" />
      ...
      <section v-if="subUrl" class="vpn-profiles__section">
        ...
        <div class="vpn-profiles__sub-url">
          <input
            ...
            readonly
          />
          <Button variant="primary" size="sm" @click="handleCopySubUrl">
            {{ copied ? 'Copied!' : 'Copy' }}
          </Button>
        </div>
      </section>
        ...
        <div v-else class="vpn-profiles__grid">
          <div v-for="profile in profiles" :key="profile.type" class="profile-card">
            ...
            <div class="profile-card__actions">
              <StatusPill :status="profile.available ? 'active' : 'disabled'">
