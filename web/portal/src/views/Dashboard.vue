...
<template>
  <div class="dashboard">
    ...
    <Skeleton v-if="usageStore.loading && !usageStore.usage" type="card" :count="3" />
    ...
    <template v-else>
      ...
      <div class="dashboard__usage">
        <div class="usage-card">
          ...
          <!-- Usage gauge -->
          <UsageBar :used="totalUsageBytes" :limit="maxDataBytes || 0" />
      ...
      <div class="dashboard__sessions" v-if="activeSessionsList.length > 0">
        <div class="sessions-card">
          <div class="sessions-card__header">
            ...
            <StatusPill status="active">{{ activeSessionsList.length }} active</StatusPill>
          </div>
