...
<template>
  <div class="wg-peers">
    ...
    <Skeleton v-if="loading && !peers.length" type="card" :count="2" />
      ...
      <div v-for="peer in peers" :key="peer.id" class="wg-peers__card">
        <div class="wg-peers__card-info">
          <div class="wg-peers__card-header">
            ...
            <StatusPill :status="statusVariant(peer.status)">
        ...
        <div class="wg-peers__card-actions">
          ...
          <Button variant="ghost" size="sm" @click="openQRModal(peer.id, peer.node_name)">
