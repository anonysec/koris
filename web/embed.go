...
// AdminFS contains the built admin dashboard SPA (web/admin/www/).
//
//go:embed all:admin/www
var AdminFS embed.FS

// PortalFS contains the built customer portal SPA (web/portal/www/).
//
//go:embed all:portal/www
var PortalFS embed.FS

// LandingFS contains the built landing page SPA (web/landing/www/).
//
