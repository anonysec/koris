  ...
  <div class="page ticket-detail">
    ...
    <template v-else-if="ticket">
      ...
      <div class="ticket-topbar">
        <Button variant="ghost" size="sm" @click="router.push({ name: 'tickets' })">
          ← {{ t('tickets.back') }}
        </Button>
          ...
          <section class="reply-section">
            ...
            <form class="reply-form" @submit.prevent="sendReply">
              ...
              <div class="reply-form__actions">
                ...
                <Button type="submit" :variant="isInternal ? 'secondary' : 'primary'" :loading="sending" :disabled="!replyText.trim()">
    ...
    <div v-else class="empty-state">
      ...
      <Button variant="ghost" @click="router.push({ name: 'tickets' })">{{ t('tickets.go_back') }}</Button>
    </div>
  </div>
</template>
