  ...
  <div class="page migrate-view">
    ...
    <section class="migrate-form-section">
      <div class="migrate-form">
        <FormField name="migrate-source" :label="t('migrate.source_node')" required>
        ...
        <FormField name="migrate-dest" :label="t('migrate.dest_node')" required>
          <template #default="{ fieldId }">
            <Select
              :id="fieldId"
              v-model="destNodeId"
      ...
      <div class="progress-card">
        ...
        <div v-if="migrationResult" class="migrate-summary">
          ...
          <div class="migrate-summary__actions">
            <Button variant="primary" @click="resetMigration">
