    ...
    <main class="setup-form-wrapper">
      <form class="setup-form" @submit.prevent="handleSetup">
        ...
        <div class="setup-form__fields">
          ...
          <FormField v-if="store.setupKeyRequired" name="setup-key" :label="t('setup.setup_key')" :hint="t('setup.setup_key_hint')">
          ...
          <FormField name="setup-username" :label="t('login.username')" :error="errors.username" required>
            <template #default="{ fieldId, describedBy }">
              <Input
                :id="fieldId"
                v-model="username"
          ...
          <FormField name="setup-password" :label="t('login.password')" :error="errors.password" required>
            <template #default="{ fieldId, describedBy }">
              <Input
                :id="fieldId"
                v-model="password"
          ...
          <FormField name="setup-confirm" :label="t('setup.confirm_password')" :error="errors.confirm" required>
            <template #default="{ fieldId, describedBy }">
              <Input
                :id="fieldId"
