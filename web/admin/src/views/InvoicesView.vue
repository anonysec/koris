  ...
  <div class="page invoices-view">
    ...
    <section class="panel">
        ...
        <table class="data-table" role="table">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                <KStatusPill :status="statusVariant(inv.status)" size="sm">
              ...
              <td>
                <div class="action-btns" @click.stop>
                  <KButton variant="ghost" size="sm" @click="downloadInvoice(inv)">
                    📥 {{ t('invoices.download') }}
                  </KButton>
                  <KButton
      ...
      <div v-if="totalCount > pageSize" class="pagination">
        <KButton variant="ghost" size="sm" :disabled="page <= 1" @click="prevPage">
          ← {{ t('invoices.prev') }}
        </KButton>
        <span class="pagination__info">{{ page }} / {{ totalPages }}</span>
        <KButton variant="ghost" size="sm" :disabled="page >= totalPages" @click="nextPage">
          {{ t('invoices.next') }} →
        </KButton>
      </div>
    </section>
    ...
    <KDrawer :open="showDetail" :title="t('invoices.detail_title')" side="right" @close="showDetail = false">
      <div v-if="selectedInvoice" class="invoice-detail">
        ...
        <div class="detail-row">
          ...
          <KStatusPill :status="statusVariant(selectedInvoice.status)" size="sm">
        ...
        <div class="detail-actions">
          <KButton variant="primary" size="sm" @click="downloadInvoice(selectedInvoice)">
            📥 {{ t('invoices.download') }}
          </KButton>
          <KButton
    ...
    <!-- Refund Drawer -->
    <KDrawer :open="showRefundDrawer" :title="t('invoices.refund_title')" side="right" @close="showRefundDrawer = false">
      <form v-if="refundInvoice" class="refund-form" @submit.prevent="submitRefund">
        ...
        <KFormField name="refund-amount" :label="t('invoices.refund_amount')">
        ...
        <KButton type="submit" variant="danger" :loading="refundLoading" full-width>
