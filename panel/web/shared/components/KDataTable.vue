...
.k-table__th--check { width: 40px; padding: var(--space-3) var(--space-2); }
...
.k-table__td--check { width: 40px; padding: var(--space-3) var(--space-2); }
.k-table__checkbox { width: 16px; height: 16px; accent-color: var(--color-primary); cursor: pointer; }
