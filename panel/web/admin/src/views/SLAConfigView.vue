    ...
    <div class="sla-grid">
      ...
      <section class="panel config-panel">
        ...
        <div v-if="loadingConfig" class="skeleton-wrap">
          <KSkeleton variant="rect" :height="200" />
        </div>
        ...
        <form v-else class="sla-form" @submit.prevent="saveConfig">
          ...
          <div class="priority-inputs">
            ...
            <div class="priority-row">
              ...
              <KFormField name="urgent" :label="t('sla.minutes')">
            ...
            <div class="priority-row">
              ...
              <KFormField name="high" :label="t('sla.minutes')">
                <template #default="{ fieldId }">
                  <KInput
                    :id="fieldId"
                    v-model="highMinutes"
            ...
            <div class="priority-row">
              ...
              <KFormField name="normal" :label="t('sla.minutes')">
                <template #default="{ fieldId }">
                  <KInput
                    :id="fieldId"
            ...
            <div class="priority-row">
              ...
              <KFormField name="low" :label="t('sla.minutes')">
                <template #default="{ fieldId }">
                  <KInput
                    :id="fieldId"
                    v-model="lowMinutes"
