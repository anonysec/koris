...
<template>
  <div class="page anyconnect-view">
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr v-for="node in nodes" :key="node.id">
            ...
            <td>
              <KStatusPill :status="getCertPillStatus(node)">
                {{ getCertStatus(node) }}
              </KStatusPill>
            </td>
            <td>
              <KStatusPill :status="getServicePillStatus(node)">
    ...
    <KSlideOver :open="showEnableModal" :title="t('anyconnect.enable_title')" @close="showEnableModal = false">
      <form class="enable-form" @submit.prevent="handleEnable">
        <KFormField name="ac-node" :label="t('anyconnect.field_node')" required>
        ...
        <KFormField name="ac-port" :label="t('anyconnect.field_port')" required>
          <template #default="{ fieldId }">
        ...
        <div class="form-actions">
          ...
          <KButton type="submit" variant="primary" :loading="enabling">{{ t('anyconnect.enable') }}</KButton>
        </div>
      </form>
    </KSlideOver>
  </div>
