-- Payment approval intent workflow.
-- wallet_topup: approval credits wallet.
-- plan_renewal: approval credits wallet and applies the target plan when wallet is sufficient.
