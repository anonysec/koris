...
- **Configurable URL routing**: `PANEL_ADMIN_PATH`, `PANEL_PORTAL_PATH`, `PANEL_ADMIN_HOST`, `PANEL_PORTAL_HOST` env vars. Vite base is env-driven via `KORIS_ADMIN_BASE` / `KORIS_PORTAL_BASE` at build time.
